...
To make it a square root function, we could do: h<sub>θ</sub>(x) = θ<sub>0</sub> + θ<sub>1</sub>x<sub>1</sub> + θ<sub>2</sub><span>&radic;<span style="text-decoration:overline">x1</span></span>
​	 
